    ...
    >
      ...
      <div className="relative">
        ...
        <MagneticButton
          ...
          aria-expanded={open}
          className="relative w-16 h-16 rounded-full bg-secondary text-on-secondary border border-white/20 shadow-[0_32px_80px_-32px_rgba(198,150,60,0.45)] flex items-center justify-center overflow-hidden transition-all duration-300 hover:shadow-[0_35px_100px_-30px_rgba(198,150,60,0.55)]"
        >
